...
Rewrite the above from the following:

From SIF 2:

This infrastructure will enable the Alice Lab at York University to develop transferable knowledge, technology, creative practice and training in collaborative creativity through human and artificial intelligence within immersive media including Virtual Reality (VR) and Augmented Reality (AR).

The proposed infrastructure will support a unique and forward-thinking program of research directed by Dr. Wakefield through a renewed CRC Tier 2 in Computational Worldmaking, to develop research, software, art, and training toward collaborative human-machine creativity within immersive media including Virtual Reality (VR) and Augmented Reality (AR). The program will extend an established profile of well-cited research, technology transfer in use by thousands, and an internationally successful and award-winning art. It will result in new software for artists to co-create immersive worlds from within the worlds themselves. As collaborative improvisations enacted with the whole body, this will radically change how we sculpt complex forms and behaviours. Moreover, these worlds will be more responsive, playful, and curious. Disseminated in public venues, they will share a different conception of the cohabitation of human and artificial beings. Doing so requires powerful computing for responsive AI endowed with human-centric, multi-modal awareness along with technology to support knowledge mobilization in a growing research team at the state of the art. By addressing VR/AR and AI, the research contributes to two of the most rapidly evolving and both economically and culturally significant sectors of technology industry and digital culture today. Its specialized technical, scientific, and creative research training in these sectors give trainees invaluable expertise for the provincial job market. It highlights Ontario’s growing reputation as a center for creativity in technology, film, and game, and a leader in immersive media; and its commitment to investigating AI in technological, creative, and cultural engagement.

From CRC 2:

Wakefield, Graham (SSHRC - Tier 2)
The proposed program of interdisciplinary research-creation applies a deep commitment to the open-endedness of computation—as an art material—toward technologies of artificial intelligence within immersive mixed reality. The research and training program will result in new software for artists to co-create immersive worlds—as art installations—from within the worlds themselves. As collaborative improvisations enacted with the whole body, this will radically change how we sculpt complex forms and behaviours.. Moreover, these worlds will be more responsive, playful, and curious. Disseminated in public venues, they will share a different conception of the cohabitation of human and artificial beings.

From JELF 2:

The proposed Infrastructure for Embodied Multimodal Awareness in Human-Machine Creativity will support a unique and forward-thinking program of research directed by Dr. Wakefield through a renewed CRC Tier 2 in Computational Worldmaking. It develops research, software, art, and training toward collaborative human- machine creativity within immersive media including Virtual Reality (VR) and Augmented Reality (AR). It will result in new software for artists to co-create immersive worlds from within the worlds themselves. As collaborative improvisations enacted with the whole body, this will radically change how we sculpt complex forms and behaviours. Moreover, these worlds will be more responsive, playful, and curious. Disseminated in public venues, they will share a different conception of the cohabitation of human and artificial beings.

JELF 1:

We are entering an age of mixed reality in which virtual spaces of information are blended with real space through spatially- and human-aware sensors and immersive displays. Public excitement about the emergence of technologies capable of creating life-like interactive experiences in virtual worlds, and blending them the real to create "augmented" reality, parallels the enthusiasm brought on by the birth of cinema. Likewise, industry is investing heavily, yet acknowledges the necessity of new creative technologies, techniques, genres and aesthetic practices.
With the requested infrastructure this research program will address these challenges via a unique lens of computational creativity. Inspired by the creativity of nature, the program leverages the self-modifying capacity of computational media to create artificial worlds whose rules can be rewritten while participants interact within them, supporting unprecedented levels of human-machine interaction and intensified aesthetic experience through meaningful engagement using the whole body.
Unique to Canada, this program nestles within York's rapidly advancing cluster of research spanning art, design, engineering and science. It will provide training and software resources to computationally literate artists and "creative coders" and build partnerships with Canada's most innovative entertainment, arts and cultural industries, cementing Canada's leadership in a vital new wave of media generation.
